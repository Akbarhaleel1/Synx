...
//         <p>Search for Google Place ID Tool: Go to Google and search for "Google Place ID Finder" or visit Google's Place ID Finder.
//           Enter Your Business Name: In the Place ID Finder tool, search for your business or location by typing the name in the search bar.
//           Find Your Business: From the search results, locate your business and click on it.
//           Copy the Place ID: Once your business is selected, a Place ID will appear below the search box. Highlight the Place ID, right-click, and choose "Copy."
//           Paste the Place ID: Go to the input box where you're asked to paste the Place ID, right-click, and select "Paste", or press Ctrl + V (Windows) or Cmd + V (Mac).
//           Click the 'Integrate' Button: After pasting the Place ID, click the "Integrate" button to use the ID in your platform.</p>
...
//   const [showMore, setShowMore] = useState(false); // For "Read More"
...
//           <li>In the Place ID Finder, search for your business by entering the name.</li>
//           <li>Select your business from the results.</li>
//           <li>Copy the <strong>Place ID</strong> that appears below the search box.</li>
//           <li>Paste the Place ID into the input field below.</li>
//           <li>Click the "Integrate" button to link the page to {platform.name}.</li>
//         </ul>
...
//             <p className="mb-2">
//               To find the Google Place ID:
//             </p>
//             <ol className="list-decimal list-inside mb-4">
//               <li>Go to Google and search for "Google Place ID Finder" or visit the Place ID Finder tool.</li>
//               <li>Search for your business or location by typing the name in the search bar.</li>
//               <li>From the search results, locate your business and click on it.</li>
//               <li>Copy the Place ID shown below the search box.</li>
//               <li>Paste the Place ID in the input box below.</li>
//             </ol>
//           </div>
//         )}
